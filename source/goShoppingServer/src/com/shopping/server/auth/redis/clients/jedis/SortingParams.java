...
import static com.shopping.server.auth.redis.clients.jedis.Protocol.Keyword.ALPHA;
import static com.shopping.server.auth.redis.clients.jedis.Protocol.Keyword.ASC;
import static com.shopping.server.auth.redis.clients.jedis.Protocol.Keyword.BY;
import static com.shopping.server.auth.redis.clients.jedis.Protocol.Keyword.DESC;
import static com.shopping.server.auth.redis.clients.jedis.Protocol.Keyword.GET;
import static com.shopping.server.auth.redis.clients.jedis.Protocol.Keyword.LIMIT;
import static com.shopping.server.auth.redis.clients.jedis.Protocol.Keyword.NOSORT;
