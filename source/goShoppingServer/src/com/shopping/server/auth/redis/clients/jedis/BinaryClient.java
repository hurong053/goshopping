...
import static com.shopping.server.auth.redis.clients.jedis.Protocol.toByteArray;
import static com.shopping.server.auth.redis.clients.jedis.Protocol.Command.*;
import static com.shopping.server.auth.redis.clients.jedis.Protocol.Keyword.ENCODING;
import static com.shopping.server.auth.redis.clients.jedis.Protocol.Keyword.IDLETIME;
import static com.shopping.server.auth.redis.clients.jedis.Protocol.Keyword.LEN;
import static com.shopping.server.auth.redis.clients.jedis.Protocol.Keyword.LIMIT;
import static com.shopping.server.auth.redis.clients.jedis.Protocol.Keyword.NO;
import static com.shopping.server.auth.redis.clients.jedis.Protocol.Keyword.ONE;
import static com.shopping.server.auth.redis.clients.jedis.Protocol.Keyword.REFCOUNT;
import static com.shopping.server.auth.redis.clients.jedis.Protocol.Keyword.RESET;
import static com.shopping.server.auth.redis.clients.jedis.Protocol.Keyword.STORE;
import static com.shopping.server.auth.redis.clients.jedis.Protocol.Keyword.WITHSCORES;
...
import com.shopping.server.auth.redis.clients.jedis.Protocol.Command;
import com.shopping.server.auth.redis.clients.jedis.Protocol.Keyword;
import com.shopping.server.auth.redis.clients.util.SafeEncoder;
